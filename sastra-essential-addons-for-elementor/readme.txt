...
### [Woocommerce Elementor Addons](https://spexoaddons.com/widgets/woocommerce-elementor-addons/) & Widgets:
...
- [Elementor Lottie Animation](https://spexoaddons.com/widgets/elementor-lottie-animation/)
...
**Checkout other widgets on our [Widgets Demo Page](https://spexoaddons.com/widgets/)**
...
= Can I use Spexo Addons for Elementor on a wordpress.com site? =
...
== Changelog ==
= Spexo Addons for Elementor v1.0 - 2024-01-30 =
* Initial Release.
= Spexo Addons for Elementor v1.0.1 - 2024-04-24 =
* Security Patch Update
= Spexo Addons for Elementor v1.0.2 - 2024-05-31 =
* Security Patches and Performance Improvements
= Spexo Addons for Elementor v1.0.3 - 2024-06-14 =
* Widgets bug fixes
...
* New: Added support for Spexo theme on their pre-built websites.
...
* Fixed: Global font style does not work in subtitles of Advanced Slider Widget
* Fixed: Icon doesn't work in Recent Post List widget
* Fixed: Hover effect doesn't work for filter tabbing in Post Grid/Slider/Carousel and Product Grid/Slider/Carousel widgets
* Fixed: Post Grid/Slider/Carousel Extra Icon not showing on frontend
* Fixed: Advanced Slider/Carousel column doesn't work between 1220px to 1200px screen size
* Fixed: Product Grid/Slider/Carousel Slider doesn't work as mega menu content   
* Fixed: When scrolling the page, the scroll stops and jerks
* Fixed: Sticky Elements are conflict when one or more element are sticky

= v1.0.7 - 2024-11-09 =

* Fixed: Hover transition duration of post list icon not set in Recent Post list Widget
* Improved: Optimized the demo import process for download plugins as per demo requirement

= v1.0.8 - 2024-11-15 =

* Fixed: Feature image not upload in post media
* Added: Admin notice when plugin network activate in multisite

= v1.0.9 - 2024-12-11 =

* Added: Spexo Theme Support
