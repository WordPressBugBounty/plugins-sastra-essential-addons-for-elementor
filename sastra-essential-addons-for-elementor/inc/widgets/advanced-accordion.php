...
class TMPCODER_Advanced_Accordion extends Widget_Base {
    ...
    protected function register_controls() {
		...
		$this->add_responsive_control(
			'tab_title_right_distance',
			[
				'label' => esc_html__( 'Title Right Distance', 'sastra-essential-addons-for-elementor' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px'],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}}.tmpcoder-advanced-accordion-icon-no-box .tmpcoder-acc-item-title .tmpcoder-acc-title-text' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}}.tmpcoder-advanced-accordion-icon-side-box .tmpcoder-acc-item-title .tmpcoder-acc-title-text' => 'margin-right: calc({{accordion_title_icon_box_width.SIZE}}{{accordion_title_icon_box_width.UNIT}} + {{SIZE}}{{UNIT}});',
					'{{WRAPPER}}.tmpcoder-advanced-accordion-icon-side-curve .tmpcoder-acc-item-title .tmpcoder-acc-title-text' => 'margin-right: calc({{accordion_title_icon_box_width.SIZE}}{{accordion_title_icon_box_width.UNIT}} + {{accordion_title_icon_after_box_width.SIZE}}{{accordion_title_icon_after_box_width.UNIT}} + {{SIZE}}{{UNIT}});',
				],
			]
		);
					...
					<div class="tmpcoder-accordion-item-wrap">
						<button class="tmpcoder-acc-button">
							<span class="tmpcoder-acc-item-title">
								...
								<<?php echo esc_html( tmpcoder_validate_html_tag($settings['accordion_title_tag']) ) ?> class="tmpcoder-acc-title-text"><?php echo esc_html($acc['accordion_title']) ?></<?php echo esc_html( tmpcoder_validate_html_tag($settings['accordion_title_tag']) ); ?>>
							</span>
