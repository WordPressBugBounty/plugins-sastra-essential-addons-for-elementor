...
trait Woo_Product_Comparable {
	...
	public static function get_field_types() {
		return apply_filters( 'tmpcoder/wcpc/default-fields', [
			'image'       => __( 'Image', 'sastra-essential-addons-for-elementor' ),
			'title'       => __( 'Title', 'sastra-essential-addons-for-elementor' ),
			'price'       => __( 'Price', 'sastra-essential-addons-for-elementor' ),
			'add-to-cart' => __( 'Add to cart', 'sastra-essential-addons-for-elementor' ),
			'description' => __( 'Description', 'sastra-essential-addons-for-elementor' ),
			'sku'         => __( 'SKU', 'sastra-essential-addons-for-elementor' ),
			'stock'       => __( 'Availability', 'sastra-essential-addons-for-elementor' ),
			'weight'      => __( 'weight', 'sastra-essential-addons-for-elementor' ),
			'dimension'   => __( 'Dimension', 'sastra-essential-addons-for-elementor' ),
		] + self::get_wc_attr_taxonomies_list() );
	}

	public static function get_themes() {
		return apply_filters( 'tmpcoder/wcpc/default-themes', [
			''        => __( 'Theme Default', 'sastra-essential-addons-for-elementor' ),
			'theme-1' => __( 'Theme 1', 'sastra-essential-addons-for-elementor' ),
			'theme-2' => __( 'Theme 2', 'sastra-essential-addons-for-elementor' ),
			'theme-3' => __( 'Theme 3', 'sastra-essential-addons-for-elementor' ),
			'theme-4' => __( 'Theme 4', 'sastra-essential-addons-for-elementor' ),
			'theme-5' => __( 'Theme 5', 'sastra-essential-addons-for-elementor' ),
			'theme-6' => __( 'Theme 6', 'sastra-essential-addons-for-elementor' ),
		] );
	}
	...
	public static function get_default_rf_fields() {
		return apply_filters( 'tmpcoder/wcpc/default-rf-fields', [
			[
				'field_type'  => 'image',
				'field_label' => __( 'Image', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'title',
				'field_label' => __( 'Title', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'price',
				'field_label' => __( 'Price', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'description',
				'field_label' => __( 'Description', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'add-to-cart',
				'field_label' => __( 'Add to cart', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'sku',
				'field_label' => __( 'SKU', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'stock',
				'field_label' => __( 'Availability', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'weight',
				'field_label' => __( 'Weight', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'dimension',
				'field_label' => __( 'Dimension', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'pa_color',
				'field_label' => __( 'Color', 'sastra-essential-addons-for-elementor' ),
			],
			[
				'field_type'  => 'pa_size',
				'field_label' => __( 'Size', 'sastra-essential-addons-for-elementor' ),
			],
		] );
	}
	...
	protected function init_content_wc_notice_controls() {
		if ( ! function_exists( 'WC' ) ) {
			$this->start_controls_section( 'tmpcoder_global_warning', [
				'label' => __( 'Warning!', 'sastra-essential-addons-for-elementor' ),
			] );
			$this->add_control( 'tmpcoder_global_warning_text', [
	...
	public function init_content_product_compare_controls() {
		$sec_args = [
			'label' => __( 'Product Compare', 'sastra-essential-addons-for-elementor' ),
		];
		if ( 'tmpcoder-woo-product-compare' !== $this->get_name() ) {
			$sec_args['condition'] = [
				'show_compare' => 'yes',
			];
		}
		...
		if ( 'tmpcoder-woo-product-compare' === $this->get_name() ) {
			...
			$this->add_control( 'show_compare', [
				'label'   => esc_html__( 'Show Product Compare?', 'sastra-essential-addons-for-elementor' ),
				'type'    => Controls_Manager::HIDDEN,
				'default' => 'yes',
			] );

            $this->add_control( "product_ids", [
                'label'       => __( 'Products', 'sastra-essential-addons-for-elementor' ),
                'description' => __( 'Enter Product IDs separated by a comma', 'sastra-essential-addons-for-elementor' ),
                'type'        => 'tmpcoder-select2',
                'label_block' => true,
                'multiple'    => true,
                'source_type' => 'product',
                'source_name' => 'post_type',
                'placeholder' => __( 'Search by Product Name', 'sastra-essential-addons-for-elementor' ),
            ] );

			$this->add_control( "highlighted_product_id", [
				'label'       => __( 'Highlighted Product', 'sastra-essential-addons-for-elementor' ),
                'type'        => 'tmpcoder-select2',
                'label_block' => true,
                'source_type' => 'product',
                'source_name' => 'post_type',
				'description' => __( 'Enter any ID from the Product IDs used above', 'sastra-essential-addons-for-elementor' ),
				'condition'   => [
					'theme' => [
						'theme-3',
						'theme-4',
		...
		$this->add_control( 'theme', [
			'label'   => __( 'Presets', 'sastra-essential-addons-for-elementor' ),
			'type'    => Controls_Manager::SELECT,
			'options' => $this->get_themes(),
			'default' => '',
		] );
		$this->add_control( "ribbon", [
			'label'       => __( 'Ribbon Text', 'sastra-essential-addons-for-elementor' ),
			'type'        => Controls_Manager::TEXT,
			'placeholder' => __( 'eg. New', 'sastra-essential-addons-for-elementor' ),
			'default'     => __( 'New', 'sastra-essential-addons-for-elementor' ),
			'condition'   => [
				'theme' => 'theme-4',
			],
		] );
	...
	public function init_content_table_settings_controls() {
		$this->start_controls_section( 'section_content_table', [
			'label'     => __( 'Compare Table Settings', 'sastra-essential-addons-for-elementor' ),
			'condition' => [
				'show_compare' => 'yes',
			],
		] );
		$this->add_control( "table_title", [
			'label'       => __( 'Table Title', 'sastra-essential-addons-for-elementor' ),
			'type'        => Controls_Manager::TEXT,
			'default'     => __( 'Compare Products', 'sastra-essential-addons-for-elementor' ),
			'placeholder' => __( 'Compare Products', 'sastra-essential-addons-for-elementor' ),
		] );
        $this->add_control(
            'table_title_tag',
            [
                'label' => __( 'Table Title HTML Tag', 'sastra-essential-addons-for-elementor' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'h1' => 'H1',
                    'h2' => 'H2',
		...
		$repeater->add_control( 'field_type', [
			'label'   => __( 'Type', 'sastra-essential-addons-for-elementor' ),
			'type'    => Controls_Manager::SELECT,
		...
		$this->add_control( 'fields', [
			'label'       => __( 'Fields to show', 'sastra-essential-addons-for-elementor' ),
			'description' => __( 'Select the fields to show in the comparison table', 'sastra-essential-addons-for-elementor' ),
			'type'        => Controls_Manager::REPEATER,
			'fields'      => apply_filters( 'tmpcoder/wcpc/rf-fields', $repeater->get_controls() ),
			'default'     => $this->get_default_rf_fields(),
			'title_field' => '{{ field_label }}',
		] );
		$this->add_control( 'repeat_price', [
			'label'       => __( 'Repeat "Price" field', 'sastra-essential-addons-for-elementor' ),
			'description' => __( 'Repeat the "Price" field at the end of the table', 'sastra-essential-addons-for-elementor' ),
			'type'        => Controls_Manager::SWITCHER,
			'default'     => 'yes',
		] );
		$this->add_control( 'repeat_add_to_cart', [
			'label'       => __( 'Repeat "Add to cart" field', 'sastra-essential-addons-for-elementor' ),
			'description' => __( 'Repeat the "Add to cart" field at the end of the table', 'sastra-essential-addons-for-elementor' ),
			'type'        => Controls_Manager::SWITCHER,
		] );
		$this->add_control( 'linkable_img', [
			'label'       => __( 'Make Product Image Linkable', 'sastra-essential-addons-for-elementor' ),
			'description' => __( 'You can link the product image to product details page', 'sastra-essential-addons-for-elementor' ),
			'type'        => Controls_Manager::SWITCHER,
		] );
		$this->add_control( 'field_icon', [
			'label'   => __( 'Fields Icon', 'sastra-essential-addons-for-elementor' ),
			'type'    => Controls_Manager::ICONS,
		] );
        if ( 'eicon-woocommerce' === $this->get_name()) {
            $this->add_control( "no_products_found_text", [
                'label'       => __( 'Text for "No products are found to compare"', 'sastra-essential-addons-for-elementor' ),
                'default' => __( 'No products are added to Compare. Please add products to compare.', 'sastra-essential-addons-for-elementor' ),
                'type'        => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'placeholder' => __( 'Eg. No products are added to Compare.', 'sastra-essential-addons-for-elementor' ),
            ] );
		}
	...
	public function init_style_content_controls( $css_classes = [] ) {
		...
		$this->start_controls_section( 'section_style_general', [
			'label'     => __( 'Compare Table General', 'sastra-essential-addons-for-elementor' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'show_compare' => 'yes',
			],
		] );
		$container_class = ! empty( $container_class ) ? $container_class : '{{WRAPPER}} .tmpcoder-wcpc-wrapper';
		$this->add_responsive_control( "tmpcoder_container_width", [
		...
		$this->add_responsive_control( "tmpcoder_container_margin", [
		...
		$this->add_responsive_control( "tmpcoder_container_padding", [
		...
		$this->add_group_control( Group_Control_Border::get_type(), [
			'name'     => "tmpcoder_container_border",
			'selector' => $container_class,
		] );
		$this->add_control( "tmpcoder_container_border_radius", [
		...
		$this->add_group_control( Group_Control_Background::get_type(), [
			'name'     => "tmpcoder_container_bg_color",
		...
		$this->add_group_control( Group_Control_Box_Shadow::get_type(), [
			'label'    => __( 'Container Box Shadow', 'sastra-essential-addons-for-elementor' ),
			'name'     => 'tmpcoder_container_shadow',
			'selector' => $container_class,
			'exclude'  => [
				'box_shadow_position',
			],
	...
	public function init_style_table_controls( $css_classes = [] ) {
		extract( $css_classes );
		$table            = isset( $table ) ? $table : "{{WRAPPER}} .tmpcoder-wcpc-wrapper table";
		$table_title      = isset( $table_title ) ? $table_title : "{{WRAPPER}} .tmpcoder-wcpc-wrapper .wcpc-title";
		$table_title_wrap = isset( $table_title_wrap ) ? $table_title_wrap : "{{WRAPPER}} .tmpcoder-wcpc-wrapper .first-th";

		$this->start_controls_section( 'section_style_table', [
			'label'     => __( 'Table Style', 'sastra-essential-addons-for-elementor' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'show_compare' => 'yes',
			],
		...
		$this->add_control( 'separate_col_style', [
			'label' => __( 'Style Content Column Separately', 'sastra-essential-addons-for-elementor' ),
			'type'  => Controls_Manager::SWITCHER,
		] );
		//-------Table Style--------
		$this->add_control( 'table_style_pot', [
			...
			'label_off'    => __( 'Default', 'sastra-essential-addons-for-elementor' ),
			'label_on'     => __( 'Custom', 'sastra-essential-addons-for-elementor' ),
			'return_value' => 'yes',
		] );
		$this->start_popover();
		$this->add_responsive_control( "table_width", [
			'label'      => esc_html__( 'Table Width', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [
				'px',
				'rem',
		...
		$this->add_responsive_control( "table_margin", [
			'label'      => __( 'Table Margin', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [
				'px',
				'em',
...
//			'label'      => __( 'Table Padding', 'sastra-essential-addons-for-elementor' ),
//			'type'       => Controls_Manager::DIMENSIONS,
//			'size_units' => [
//				'px',
//				'em',
...
//		] );
		...
		$this->add_control( 'tbl_brd_heading', [
			'label'     => __( 'Table Border', 'sastra-essential-addons-for-elementor' ),
		...
		$this->add_control( 'tbl_ttl_style_pot', [
			'label'        => __( 'Table Title Style', 'sastra-essential-addons-for-elementor' ),
			'type'         => Controls_Manager::POPOVER_TOGGLE,
			'label_off'    => __( 'Default', 'sastra-essential-addons-for-elementor' ),
			'label_on'     => __( 'Custom', 'sastra-essential-addons-for-elementor' ),
			'return_value' => 'yes',
		...
		$this->add_control( 'tbl_title_color', [
			'label'     => __( 'Table Title Text Color', 'sastra-essential-addons-for-elementor' ),
		...
		$this->add_control( 'tbl_title_bg', [
			'label'     => __( 'Table Title Background', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $table_title_wrap => 'background-color:{{VALUE}}' ],
			'condition' => [ 'tbl_ttl_style_pot' => 'yes' ],
		] );
		$this->add_responsive_control( "table_title_padding", [
			'label'      => __( 'Table Title Padding', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [
				'px',
				'em',
		...
		$this->add_control( 'tbl_title_brd_heading', [
			'label'     => __( 'Table Title Border', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => [ 'tbl_ttl_style_pot' => 'yes' ],
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'label'     => __( 'Table Title Typography', 'sastra-essential-addons-for-elementor' ),
	...
	public function init_style_table_common_style( $tbl = '' ) {
		$tbl = ! empty( $tbl ) ? $tbl : "{{WRAPPER}} .tmpcoder-wcpc-wrapper table";
		$td  = "{$tbl} td";
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'      => "title_row_typo",
			'label'     => __( 'Product Title Row Typography', 'sastra-essential-addons-for-elementor' ),
			'selector'  => $title_row,
			'condition' => [
		...
		$this->add_control( 'common_th_style_pot', [
			'label'        => __( 'Header Column Style', 'sastra-essential-addons-for-elementor' ),
			'type'         => Controls_Manager::POPOVER_TOGGLE,
			'label_off'    => __( 'Default', 'sastra-essential-addons-for-elementor' ),
			'label_on'     => __( 'Custom', 'sastra-essential-addons-for-elementor' ),
			'return_value' => 'yes',
		...
		$this->add_responsive_control( "table_gen_th_width", [
			'label'      => esc_html__( 'Header Column Width', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [
				'px',
				'rem',
		...
		$this->add_responsive_control( "table_gen_th_padding", [
			'label'      => __( 'Header Column Padding', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [
				'px',
				'em',
		...
		$this->add_group_control( Group_Control_Border::get_type(), [
			...
			'label'     => __( 'Header border', 'sastra-essential-addons-for-elementor' ),
			'selector'  => $th,
			'condition' => [ 'common_th_style_pot' => 'yes' ],
		] );
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'label'     => __( 'Header Column Typography', 'sastra-essential-addons-for-elementor' ),
			'selector'  => $th,
			'condition' => [
				'separate_col_style!' => 'yes',
			],
		...
		$this->add_control( 'common_td_style_pot', [
			'label'        => __( 'Product Column Style', 'sastra-essential-addons-for-elementor' ),
			'type'         => Controls_Manager::POPOVER_TOGGLE,
			'label_off'    => __( 'Default', 'sastra-essential-addons-for-elementor' ),
			'label_on'     => __( 'Custom', 'sastra-essential-addons-for-elementor' ),
			'return_value' => 'yes',
		...
		$this->add_responsive_control( "table_gen_td_width", [
			'label'      => esc_html__( 'Product Column Width', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [
				'px',
				'rem',
		...
		$this->add_responsive_control( "table_gen_td_padding", [
			'label'      => __( 'Product Column Padding', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [
				'px',
				'em',
		...
		$this->add_responsive_control( "table_gen_img_td_padding", [
			'label'      => __( 'Product Image Box Padding', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [
				'px',
				'em',
		...
		$this->add_responsive_control( "table_gen_img_padding", [
			'label'      => __( 'Product Image Padding', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [
				'px',
				'em',
		...
		$this->add_group_control( Group_Control_Border::get_type(), [
			...
			'label'     => __( 'Product column border', 'sastra-essential-addons-for-elementor' ),
			'selector'  => $td,
			'condition' => [ 'common_td_style_pot' => 'yes' ],
		] );

		$this->add_control( 'common_img_col_brd_heading', [
			'label'     => __( 'Product Image Box Border', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => [ 'common_td_style_pot' => 'yes' ],
		] );
		$this->add_group_control( Group_Control_Border::get_type(), [
			...
			'label'     => __( 'Image Box border', 'sastra-essential-addons-for-elementor' ),
			'selector'  => $img_class,
			'condition' => [ 'common_td_style_pot' => 'yes' ],
		] );
		$this->add_control( 'common_img_brd_heading', [
			'label'     => __( 'Product Image Border', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => [ 'common_td_style_pot' => 'yes' ],
		] );
		...
		$this->add_control( "common_img_border_radius", [
			'label'      => __( 'Image Border Radius', 'sastra-essential-addons-for-elementor' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [
				'px',
				'%',
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'label'     => __( 'Product Column Typography', 'sastra-essential-addons-for-elementor' ),
			'selector'  => $td,
			'condition' => [ 'separate_col_style!' => 'yes' ],
		] );
		...
		$this->add_control( 'common_colors_heading', [
			'label'     => __( 'Colors', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
			'condition' => [
				'separate_col_style!' => 'yes',
		...
		$this->add_group_control( Group_Control_Background::get_type(), [
			'name'     => "image_bg",
			'label'    => __( 'Image Background', 'sastra-essential-addons-for-elementor' ),
			'types'    => [
				'classic',
				'gradient',
			],
		...
		$this->add_control( "common_column_color_heading", [
			'label'     => __( 'Columns', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		$this->add_control( 'common_h_col_bg', [
			'label'     => __( 'Header Background', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $th => 'background-color:{{VALUE}}' ],
		] );
		$this->add_control( 'common_h_col_color', [
			'label'     => __( 'Header Text Color', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $th => 'color:{{VALUE}}' ],
		] );
		$this->add_control( 'common_td_col_bg', [
			'label'     => __( 'Product Column Background', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $td => 'background-color:{{VALUE}}' ],
		] );
		$this->add_control( 'common_td_col_color', [
			'label'     => __( 'Product Column Text Color', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $td => 'color:{{VALUE}}' ],
		] );

		$this->add_control( "common_buttons_color_heading", [
			'label'     => __( 'Buttons', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		$this->add_control( 'btn_color', [
			'label'     => __( 'Button Text Color', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $btn => 'color:{{VALUE}}' ],
		] );
		$this->add_control( 'btn_bg_color', [
			'label'     => __( 'Button Background Color', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $btn => 'background:{{VALUE}}' ],
		] );
		$this->add_control( "common_even_odd_clr_heading", [
			'label'     => __( 'Even & Odd Rows', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		$this->add_control( 'common_tr_even_bg', [
			'label'     => __( 'Even Row Background', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $tr_even => 'background-color:{{VALUE}}' ],
		] );
		$this->add_control( 'common_tr_even_color', [
			'label'     => __( 'Even Row Text Color', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $tr_even => 'color:{{VALUE}}' ],
		] );
		$this->add_control( 'common_tr_odd_bg', [
			'label'     => __( 'Odd Row Background', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $tr_odd => 'background-color:{{VALUE}}' ],
		] );
		$this->add_control( 'common_tr_odd_color', [
			'label'     => __( 'Odd Row Text Color', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $tr_odd => 'color:{{VALUE}}' ],
		] );
		$this->add_control( "title_row_color_heading", [
			'label'     => __( 'Title Row', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		$this->add_control( 'common_title_row_bg', [
			'label'     => __( 'Title Row Background', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $title_row => 'background-color:{{VALUE}}', ],
		] );
		$this->add_control( 'common_title_row_color', [
			'label'     => __( 'Title Row Text Color', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
	...
	public function init_style_header_column_style( $tbl = '' ) {
		...
		$this->start_controls_section( 'section_style_h_clm', [
			'label'     => __( 'Header Column', 'sastra-essential-addons-for-elementor' ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'separate_col_style' => 'yes',
				'show_compare'       => 'yes',
		...
		$this->add_control( 'title_h_col_bg', [
			'label'     => __( 'Title Background', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
		...
		$this->add_control( 'h_col_bg', [
			'label'     => __( 'Column Background Color', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $h_col => 'background-color:{{VALUE}}' ],
		] );
		$this->add_control( 'h_col_color', [
			'label'     => __( 'Column Text Color', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [ $h_col => 'color:{{VALUE}}' ],
		] );
		$this->add_control( "h_rows_clr_heading", [
			'label'     => __( 'Rows', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$this->add_control( 'title_border_heading', [
			'label'     => __( 'Title Border', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		$this->add_group_control( Group_Control_Border::get_type(), [
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'     => "h_col_typo",
			'label'    => __( 'Header', 'sastra-essential-addons-for-elementor' ),
			'selector' => $h_col,
		] );
		$this->end_controls_section();
	}
	...
	public function init_style_product_column_style( $column_number, $tbl = '' ) {
		...
		$this->start_controls_section( 'section_style_' . $pfx, [
			'label'     => sprintf( 
							/* Translators: %d is the product column number. */
							__( 'Product Column %d', 'sastra-essential-addons-for-elementor' ), $title_number ),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
				'separate_col_style' => 'yes',
				'show_compare'       => 'yes',
		...
		$this->add_group_control( Group_Control_Typography::get_type(), [
			...
			'label'    => sprintf( __( 'Title', 'sastra-essential-addons-for-elementor' ), $title_number ),
			'selector' => $title_row,
		] );
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'     => "{$pfx}_text_typo",
			'label'    => sprintf( __( 'Text', 'sastra-essential-addons-for-elementor' ), $title_number ),
			'selector' => $column_class,
		] );
		$this->add_group_control( Group_Control_Typography::get_type(), [
			'name'     => "{$pfx}_btn_typo",
			'label'    => sprintf( __( 'Button', 'sastra-essential-addons-for-elementor' ), $title_number ),
			'selector' => $btn,
		] );
		...
		$this->add_control( "{$pfx}_button_clr_heading", [
			'label'     => __( 'Button', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );
		...
		$this->add_control( "{$pfx}_btn_bg", [
			'label'     => __( 'Button Background', 'sastra-essential-addons-for-elementor' ),
			'type'      => Controls_Manager::COLOR,
    ...
    public function init_style_close_button_controls()
    {
        $this->start_controls_section( 'section_style_cm_close_btn', [
            'label'     => __( 'Compare Modal Close Button', 'sastra-essential-addons-for-elementor' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [
                'show_compare' => 'yes',
            ],
        ...
        $this->add_responsive_control(
            'tmpcoder_cm_close_btn_icon_size',
            [
                ...
                'selectors' => [
                    '.tmpcoder-wcpc-modal .close-modal' => 'font-size: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'tmpcoder_cm_close_btn_color',
            [
                'label' => __('Color', 'sastra-essential-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '.tmpcoder-wcpc-modal .close-modal' => 'color: {{VALUE}}!important;',
                ],
            ]
        );

        $this->add_control(
            'tmpcoder_cm_close_btn_bg',
            [
                'label' => __('Background', 'sastra-essential-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '.tmpcoder-wcpc-modal .close-modal' => 'background-color: {{VALUE}}!important;',
                ],
            ]
        );

        $this->add_control(
            'tmpcoder_cm_close_btn_border_radius',
            [
                'label' => __('Border Radius', 'sastra-essential-addons-for-elementor'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%'],
                ...
                'selectors' => [
                    '.tmpcoder-wcpc-modal .close-modal' => 'border-radius: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'tmpcoder_cm_close_btn_box_shadow',
                'label' => __('Box Shadow', 'sastra-essential-addons-for-elementor'),
                'selector' => '.tmpcoder-wcpc-modal .close-modal',
            ]
        );
        $this->end_controls_section();
    ...
    public function init_style_price_controls( $tbl = '' ) {
        ...
        $this->start_controls_section( 'section_style_price', [
            'label'     => __( 'Price Style', 'sastra-essential-addons-for-elementor' ),
            'tab'       => Controls_Manager::TAB_STYLE,
            'condition' => [
                'show_compare'       => 'yes',
            ],
        ...
        $this->add_control(
            'price_heading',
            [
                'label' => __( 'Normal Price Style', 'sastra-essential-addons-for-elementor' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_responsive_control( "price_size", [
            'label'      => esc_html__( 'Price Size', 'sastra-essential-addons-for-elementor' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [
                'px',
                'rem',
        ...
        $this->add_control( 'price_color', [
            'label'     => __( 'Price Text Color', 'sastra-essential-addons-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                $price => 'color:{{VALUE}};',
            ],
        ...
        $this->add_control( 'strike_price_color', [
            'label'     => __( 'Price Strike Text Color', 'sastra-essential-addons-for-elementor' ),
            'description'     => __( 'Only applicable when sales price is available', 'sastra-essential-addons-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                $strike => 'color:{{VALUE}};',
            ],
        ...
        $this->add_control(
            'sales_price_heading',
            [
                'label' => __( 'Sales Price Style', 'sastra-essential-addons-for-elementor' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_responsive_control( "sales_price_size", [
            'label'      => esc_html__( 'Sales Price Size', 'sastra-essential-addons-for-elementor' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [
                'px',
                'rem',
        ...
        $this->add_control( 'sales_price_color', [
            'label'     => __( 'Sales Price Text Color', 'sastra-essential-addons-for-elementor' ),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
    ...
    {
        $section_args = [
            'label' => esc_html__('Compare Button', 'sastra-essential-addons-for-elementor'),
            'tab' => Controls_Manager::TAB_STYLE,
        ];
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .tmpcoder-product-grid .woocommerce li.product .button.tmpcoder-wc-compare,
                    {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .product-link,
                    {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .tmpcoder-wc-compare' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .tmpcoder-product-grid .woocommerce li.product .button.tmpcoder-wc-compare,
                    {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .product-link,
                    {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .tmpcoder-wc-compare' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_tab('compare_btn_style_tab_normal', ['label' => esc_html__('Normal', 'sastra-essential-addons-for-elementor')]);

        $this->add_control(
            'compare_btn_color',
            [
                'label' => esc_html__('Button Text Color', 'sastra-essential-addons-for-elementor'),
                'type' => Controls_Manager::COLOR,
                'default' => '#fff',
                'selectors' => [
                    '{{WRAPPER}} .tmpcoder-product-grid .woocommerce li.product .button.tmpcoder-wc-compare' => 'color: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .tmpcoder-wc-compare' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tmpcoder-product-grid .woocommerce li.product .button.tmpcoder-wc-compare,
                {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .product-link,
                {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .tmpcoder-wc-compare',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .tmpcoder-product-grid .woocommerce li.product .button.tmpcoder-wc-compare, {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .product-link, {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .tmpcoder-wc-compare',
            ]
        );
        ...
        $this->start_controls_tab('compare_btn_hover_tab', ['label' => esc_html__('Hover', 'sastra-essential-addons-for-elementor')]);
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selectors' => [
                    '{{WRAPPER}} .tmpcoder-product-grid .woocommerce li.product .button.tmpcoder-wc-compare:hover' => 'color: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .tmpcoder-wc-compare:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', 'sastra-essential-addons-for-elementor'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .tmpcoder-product-grid .woocommerce li.product .button.tmpcoder-wc-compare:hover,
                {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .product-link:hover,
                {{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .tmpcoder-wc-compare:hover',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => '',
                'selectors' => [
                    '{{WRAPPER}} .tmpcoder-product-grid .woocommerce li.product .button.tmpcoder-wc-compare:hover' => 'border-color: {{VALUE}};',
                    ...
                    '{{WRAPPER}} .tmpcoder-product-grid.tmpcoder-product-overlay .woocommerce ul.products li.product .overlay .tmpcoder-wc-compare:hover' => 'border-color: {{VALUE}};',
                ],
            ]
        );
	...
	public static function render_compare_table( $options ) {
		...
		$title_tag              = isset( $ds['table_title_tag'] ) ? HelperClass::tmpcoder_validate_html_tag($ds['table_title_tag'])  : 'h1';
		$ribbon                 = isset( $ds['ribbon'] ) ? HelperClass::tmpcoder_wp_kses($ds['ribbon']): '';
		...
		do_action( 'tmpcoder/wcpc/before_content_wrapper' ); ?>
        <div class="tmpcoder-wcpc-wrapper woocommerce <?php echo esc_attr( $theme_wrap_class ); ?>">
			<?php do_action( 'tmpcoder/wcpc/before_main_table' ); ?>
            <table class="tmpcoder-wcpc-table table-responsive">
                <tbody>
				...
				<?php } else {
					...
					if ( 'Spexo_Addons_Elementor\Elements\Woo_Product_Compare' !== self::class ) {
						echo '<tr class="remove-row"><th class="remove-th">&nbsp;</th>';
						$rm_index = 0;
						foreach ( $products as $product_id => $product ) {
							?>
                            <td class="rm-col<?php echo esc_attr( $rm_index ); ?>">
                                <i class="fas fa-trash tmpcoder-wc-remove" data-product-id="<?php echo esc_attr( $product_id ); ?>" title="<?php esc_attr_e( 'Remove', 'sastra-essential-addons-for-elementor' ); ?>"></i>
                            </td>
							<?php
							$rm_index ++;
						}
                        ...
                        <tr class="<?php echo esc_attr( $field ); ?>">
                            <th class="thead <?php echo esc_attr( $f_heading_class ); ?>">
                                <div class="wcpc-table-header">
									<?php if ( $field === 'image' ) {
										if ( ! empty( $title ) ) {
											printf( '<%1$s class="wcpc-title">%2$s</%1$s>', esc_html( $title_tag ), wp_kses( $title, HelperClass::tmpcoder_allowed_tags() ) );
										}
									} else {
										if ( 'theme-5' === $theme && $field === 'title' ) {
											...
											printf( '<span class="field-name">%s</span>', wp_kses( $name, HelperClass::tmpcoder_allowed_tags() ) );
							...
							foreach ( $products as $product_id => $product ) {
                                ...
                                <td class="<?php echo esc_attr( $product_class ); ?>">
                                    ...
                                    if ( $field === 'image' ) {
	                                    ...
	                                    if ( 'theme-4' === $theme ) {
		                                    echo ! empty( $product->fields['title'] ) ? sprintf( "<p class='product-title'>%s</p>", wp_kses( $product->fields['title'], HelperClass::tmpcoder_allowed_tags() ) ) : '&nbsp;';
			...
			<?php do_action( 'tmpcoder/wcpc/after_main_table' ); ?>
        </div>
		<?php do_action( 'tmpcoder/wcpc/after_content_wrapper' );
	}
	...
	public function get_products_list( $products = [] ) {
		...
		$products = apply_filters( 'tmpcoder/wcpc/products_ids', $products );
		...
		if ( ! empty( $products ) && is_array( $products ) ) {
			foreach ( $products as $product_id ) {
				...
				foreach ( $fields as $field => $name ) {
					switch ( $field ) {
						case 'title':
							$product->fields[ $field ] = HelperClass::tmpcoder_wp_kses($product->get_title());
							break;
						case 'price':
						...
						case 'description':
							...
							$product->fields[ $field ] = apply_filters( 'tmpcoder/wcpc/woocommerce_short_description', $description );
							break;
						case 'stock':
							$availability = $product->get_availability();
							if ( empty( $availability['availability'] ) ) {
								$availability['availability'] = __( 'In stock', 'sastra-essential-addons-for-elementor' );
							}
						...
						default:
							if ( taxonomy_exists( $field ) ) {
								...
								do_action( 'tmpcoder/wcpc/compare_field_' . $field, [
									$product,
									&$product->fields,
								] );
							}
		...
		return apply_filters( 'tmpcoder/wcpc/products_list', $products_list );
	}
	...
	public function fields( $products = [] ) {
		...
		if ( empty( $fields ) || ! is_array( $fields ) ) {
			return apply_filters( 'tmpcoder/wcpc/products_fields_none', [] );
		}
		...
		foreach ( $fields as $field ) {
			if ( isset( $df[ $field['field_type'] ] ) ) {
				$fields_to_show[ $field['field_type'] ] = HelperClass::tmpcoder_wp_kses($field['field_label']);
			} else {
		...
		return apply_filters( 'tmpcoder/wcpc/products_fields_to_show', $fields_to_show, $products );
	}
	...
	public function get_product_remove_url( $product_id ) {
		...
		return apply_filters( 'tmpcoder/wcpc/get_product_remove_url', esc_url_raw( add_query_arg( $url_args, site_url() ) ), $this->remove_action );
	}
	...
	public static function print_compare_button( $id = false, $btn_type = 'text' ) {
		...
		$loader = '<svg class="tmpcoder-wc-compare-loader" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style=" shape-rendering: auto; width: 14px;" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
		...
		$btn_content = '<span class="tmpcoder-wc-compare-text">' . esc_html__( 'Compare', 'sastra-essential-addons-for-elementor' ). '</span>';
        if ('icon' === $btn_type) {
			// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
            printf( '<a class="tmpcoder-wc-compare tmpcoder-wc-compare-icon" data-product-id="%1$d" rel="nofollow" title="Compare">%2$s %3$s</a>', intval( $id ), $loader, $fa_icon );
        }else{
			// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
            printf( '<a class="tmpcoder-wc-compare button" data-product-id="%1$d" rel="nofollow" title="Compare">%2$s %3$s</a>', intval( $id ), $loader, $btn_content );
        }
	}
	...
	public function get_compare_table() {
		...
		if ( ! empty( $_POST['product_id'] ) ) {
			...
			$err_msg = __( 'Product ID is missing', 'sastra-essential-addons-for-elementor' );
		}
		...
		if ( empty( $_POST['nonce'] ) || ! wp_verify_nonce( $_POST['nonce'], 'tmpcoder_product_grid' ) ) {
			if ( $ajax ) {
				wp_send_json_error( __( 'Security token did not match', 'sastra-essential-addons-for-elementor' ) );
			}
		...
		$ds          = $this->tmpcoder_get_widget_settings( $page_id, $widget_id );
