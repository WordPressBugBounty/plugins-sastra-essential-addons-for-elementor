        ...
        <div class="tmpcoder-product-wrap">
            ...
            <div class="product-details-wrap">
                ...
                if ( $should_print_excerpt ) {
                    ...
                    // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                    echo '<p>' . wp_trim_words(strip_shortcodes(get_the_excerpt() ? get_the_excerpt() : get_the_content()), $settings['tmpcoder_product_grid_excerpt_length'], $settings['tmpcoder_product_grid_excerpt_expanison_indicator']) . '</p>';
                    echo '</div>';
                };
                ?>
